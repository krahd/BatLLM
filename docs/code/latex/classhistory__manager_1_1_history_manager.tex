...
\item 
\doxymbox{\hyperlink{classhistory__manager_1_1_history_manager_a93205f61921f3bc45c8c409ecb8c13eb}{cancel\+\_\+round}} (self, str reason, \texorpdfstring{$\ast$}{*}, int\texorpdfstring{$\vert$}{|}None cancelled\+\_\+by\+\_\+bot\+\_\+id=None)
\item 
...
\begin{DoxyVerb}Get current timestamp string in ISO 8601 format.\end{DoxyVerb}
 \Hypertarget{classhistory__manager_1_1_history_manager_a93205f61921f3bc45c8c409ecb8c13eb}\index{history\_manager.HistoryManager@{history\_manager.HistoryManager}!cancel\_round@{cancel\_round}}
\index{cancel\_round@{cancel\_round}!history\_manager.HistoryManager@{history\_manager.HistoryManager}}
\doxysubsubsection{\texorpdfstring{cancel\_round()}{cancel\_round()}}
{\footnotesize\ttfamily \label{classhistory__manager_1_1_history_manager_a93205f61921f3bc45c8c409ecb8c13eb} 
history\+\_\+manager.\+History\+Manager.\+cancel\+\_\+round (\begin{DoxyParamCaption}\item[{}]{self}{, }\item[{str}]{reason}{, }\item[{\texorpdfstring{$\ast$}{*}}]{}{, }\item[{int \texorpdfstring{$\vert$}{|} None }]{cancelled\+\_\+by\+\_\+bot\+\_\+id}{ = {\ttfamily None}}\end{DoxyParamCaption})}

\begin{DoxyVerb}Abort the active round while keeping a cancelled-round record in history.\end{DoxyVerb}
